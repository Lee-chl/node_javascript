//사용자 이름 눌렀을때 댓글 로딩
doucment.querySelectorAll('#user-list tr').forEach(function (el){
    ...
    xhr.onload = function(){
        if(xhr.status === 200){
            ...
            comments.map(function(comment){
                ...
                var remove = doucment.createElement('button');
...
//사용자 등록 시
doucment.getElementById('user-form').addEventListener('submit', function (e){
    e.preventDefault();
    ...
    xhr.open('POST','/users');
    xhr.setRequestHeader('Content-Type','applixation/json');
